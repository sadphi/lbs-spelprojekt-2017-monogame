            ...
            switch (currentState)
            {
                case GameState.MainMenu:
                    ...
                    if ((newGamePadState.DPad.Down == ButtonState.Pressed && oldGamePadState.DPad.Down == ButtonState.Released) ||
                        (newKeyboardState.IsKeyDown(Keys.Down) && oldKeyboardState.IsKeyUp(Keys.Down)) || (newKeyboardState.IsKeyDown(Keys.S) && oldKeyboardState.IsKeyUp(Keys.S)))
                    {
                        currentButton++;
                    }

                    if ((newGamePadState.DPad.Up == ButtonState.Pressed && oldGamePadState.DPad.Up == ButtonState.Released) ||
                        (newKeyboardState.IsKeyDown(Keys.Up) && oldKeyboardState.IsKeyUp(Keys.Up)) || (newKeyboardState.IsKeyDown(Keys.W) && oldKeyboardState.IsKeyUp(Keys.W)))
                    {
                        currentButton--;
                    }
                    ...
                    if ((newGamePadState.Buttons.A == ButtonState.Pressed && oldGamePadState.Buttons.A == ButtonState.Released) ||
                        (newKeyboardState.IsKeyDown(Keys.Enter) && oldKeyboardState.IsKeyUp(Keys.Enter)) || (newKeyboardState.IsKeyDown(Keys.F) && oldKeyboardState.IsKeyUp(Keys.F)) || (newKeyboardState.IsKeyDown(Keys.U) && oldKeyboardState.IsKeyUp(Keys.U)))
                    {
                ...
                case GameState.LevelSelect:
                    ...
                    if ((newGamePadState.DPad.Right == ButtonState.Pressed && oldGamePadState.DPad.Right == ButtonState.Released) ||
                        (newKeyboardState.IsKeyDown(Keys.Right) && oldKeyboardState.IsKeyUp(Keys.Right)) || (newKeyboardState.IsKeyDown(Keys.D) && oldKeyboardState.IsKeyUp(Keys.D)))
                    {
                        currentLevelHighlighted++;
                    }

                    if ((newGamePadState.DPad.Left == ButtonState.Pressed && oldGamePadState.DPad.Left == ButtonState.Released) ||
                        (newKeyboardState.IsKeyDown(Keys.Left) && oldKeyboardState.IsKeyUp(Keys.Left)) || (newKeyboardState.IsKeyDown(Keys.A) && oldKeyboardState.IsKeyUp(Keys.A)))
                    {
                        currentLevelHighlighted--;
                    }
                        ...
                        (newKeyboardState.IsKeyDown(Keys.Enter) && oldKeyboardState.IsKeyUp(Keys.Enter)) || (newKeyboardState.IsKeyDown(Keys.F) && oldKeyboardState.IsKeyUp(Keys.F)) || (newKeyboardState.IsKeyDown(Keys.U) && oldKeyboardState.IsKeyUp(Keys.U)))
                    {
                        ...
                        players.Add(new Player((PlayerIndex)0, 100 + 0 * 1720, Keys.A, Keys.D, Keys.W, Keys.S, dabKey: Keys.F, fireKey: Keys.F, jumpKey: Keys.Space));
                        players.Add(new Player((PlayerIndex)1, 100 + 1 * 1720, Keys.Left, Keys.Right, Keys.Up, Keys.Down, dabKey: Keys.J, fireKey: Keys.J, jumpKey: Keys.M));
                    }

                    if ((newGamePadState.Buttons.B == ButtonState.Pressed && oldGamePadState.Buttons.B == ButtonState.Released) ||
                        (newKeyboardState.IsKeyDown(Keys.Escape) && oldKeyboardState.IsKeyUp(Keys.Escape)) || (newKeyboardState.IsKeyDown(Keys.G) && oldKeyboardState.IsKeyUp(Keys.G)) || (newKeyboardState.IsKeyDown(Keys.I) && oldKeyboardState.IsKeyUp(Keys.I)) || (newKeyboardState.IsKeyDown(Keys.R) && oldKeyboardState.IsKeyUp(Keys.R)))
                    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            switch (currentState)
            {
                ...
                case GameState.GameOver:
                    ...
                    string dabText = "Hold Fire to DAB";
